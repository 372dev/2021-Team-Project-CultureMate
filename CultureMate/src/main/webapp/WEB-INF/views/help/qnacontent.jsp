		...
		<form method="post" action='${path}/help/qnacontent'>
			<div name="form" id="form" role="form">
				...
				<div class="mb-3">
					...
					<i class="far fa-edit"></i><label for="title">문의유형</label> <i
						class="fas fa-lock" size=1x></i><label>비공개</label> <input
						type="checkbox" value='N' name="qnaOpenStatus" id="qnaOpenStatus">
				...
				<div class="mb-3">
					...
					<i class="far fa-edit"></i><label for="title">작성자</label> <input
				...
				<div class="mb-3">
					...
					<i class="far fa-edit"></i><label for="reg_id">문의제목</label> <input
						type="text" class="form-control" name="qnaTitle" id="qnaTitle"
						required>
