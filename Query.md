...
CREATE TABLE MEMBER(
    ...
    USER_ROLE VARCHAR2(15) DEFAULT 'ROLE_USER',
...
CREATE TABLE REVIEW(
  ...
  RESERVE VARCHAR2(1) DEFAULT 'N' CHECK(RESERVE IN('N', 'Y')),
  PRFNM VARCHAR2(400)
);
...
COMMENT ON COLUMN REVIEW.RESERVE IS '예약상태';
COMMENT ON COLUMN REVIEW.PRFNM IS '공연명';
COMMENT ON COLUMN REVIEW.USER_NICK IS '닉네임';
...
CREATE TABLE QNA_BOARD (
 ...
 QNA_OPEN_STATUS VARCHAR2(1) DEFAULT 'N' CHECK ( QNA_OPEN_STATUS IN('Y', 'N')),
...
COMMENT ON COLUMN QNA_BOARD.QNA_OPEN_STATUS IS 'QNA비밀글';
...
CREATE SEQUENCE SEQ_QNA_RE_ID;

COMMENT ON COLUMN QNA_REPLY.QNA_RE_ID IS '댓글번호';
COMMENT ON COLUMN QNA_REPLY.QNA_ID IS '게시글번호';
COMMENT ON COLUMN QNA_REPLY.REPLY_WRITER_NO IS '댓글작성자';
COMMENT ON COLUMN QNA_REPLY.QNA_RE_CONTENT IS '댓글내용';
COMMENT ON COLUMN QNA_REPLY.REPLY_CREATE_DATE IS '댓글작성날짜';
COMMENT ON COLUMN QNA_REPLY.REPLY_MODIFY_DATE IS '댓글수정날짜';
COMMENT ON COLUMN QNA_REPLY.STATUS IS '댓글상태';
COMMENT ON COLUMN QNA_REPLY.STATUS IS '회원ID';
